...
class TextStyleRange:
    """Stub class — placeholder for multi-style text ranges.
    Not yet implemented in this version of pyJianYingDraft.
    Defined here to prevent ImportError in add_text_impl.py.
    """

    start: int
    end: int
    style: Optional["Text_style"]

    def __init__(self, start: int, end: int, style: Optional["Text_style"] = None):
        self.start = start
        self.end = end
        self.style = style
